...
const About2 = () => {
  return (
    ...
    <main>
        ...
        {/* <!-- about Section 2 --> */}
        <section class="py-5 my-5 ab-2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6  col-md-12 mb-4 mb-lg-0 about-img-div">
                ...
                alt="Plastic reduction image" class="about-img" />
            </div>
            <div class="col-lg-6 col-md-12 d-flex align-items-center">
                <p class="fs-2 about-2 col-lg-9 col-md-10 col-sm-12 ps-lg-5 fw-light py-5 py-md-0 text-center text-lg-start">
        ...
        <section class="py-5">
            <div class="container py-5 hero-3 px-md-5 mx-md-5 px-0 mx-0 ">
                <div class="row hero-3-row">
                    <div class="col-lg-4">

                    <p style={{ marginBottom: '1.5rem', fontSize: '2.5rem', color: '#505050',fontWeight:"600" }}>
  About Us
</p>
                        ...
                        <div class="nav flex-column nav-pills me-3 col-md-8" id="v-pills-tab" role="tablist"
                            ...
                            <div class="fs-4 my-3 pb-3 ps-0" style={{ borderBottom: '2px dotted rgb(105, 105, 105)' }} id="v-pills-home-tab" data-bs-toggle="pill"
                                ...
                                aria-selected="true"><span style={{ marginBottom: '1.5rem', fontSize: '1.5rem', color: '#505050' }}>Anaura</span></div>
                            <div class="fs-4 my-3 pb-3 ps-0" style={{ borderBottom: '2px dotted rgb(105, 105, 105)' }} id="v-pills-profile-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="v-pills-profile" aria-selected="false"> <span style={{ marginBottom: '1.5rem', fontSize: '1.5rem', color: '#505050' }}>Mission</span></div>
                            <div class="fs-4 my-3 pb-3 ps-0" style={{ borderBottom: '2px dotted rgb(105, 105, 105)' }} id="v-pills-disabled-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="v-pills-disabled" aria-selected="false"><span style={{ marginBottom: '1.5rem', fontSize: '1.5rem', color: '#505050' }}>Vission</span></div>
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0">
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                ...
                                <h1 class="mb-4 fs-1" style={{ marginBottom: '1.5rem', fontSize: '2.5rem', color: '#505050',fontWeight:"600" }}>Recruitment for Creative People</h1>
        ...
        <section className='crafting'> 
            ...
            <div class="container ">
                ...
                <div class="py-5 ">
                    <div class="display-6 py-5 my-5  col-lg-10 col-md-10 col-sm-12">
                        <h1 class="mb-4" style={{ marginBottom: '1.5rem', fontSize: '3rem', color: '#505050',fontWeight:"700" }}>Crafting a Better Future Together</h1>
                        <p class="fs-3 lh-base">At Anaura we Transform recycled materials into stylish sustainable
                            products that
                            make a
        ...
        <section className='hero-last'>
            <div className="container d-flex  justify-content-center align-items-center">
                <div className="row">
                    <div className="col-12  p-5 mt-5 text-center">
                    <h1 className='ml-5 '>We’re here to save mother earth</h1>
                    <button className=' mt-4  rounded-pill btn btn-outline-light text-dark border abtbtn rounded-pill p-3'>Contact Us To Know How</button>
                    </div>
